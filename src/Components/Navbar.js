    ...
    <div className="nav-main flex items-center justify-center  h-[94px] bg-cream sm:w-[100%] sm:h-[104px] transition-all">
      <div className="inner-nav w-[1232px] h-[56px] flex items-center justify-between sm:w-[100%]">
        ...
        <div className="hamburger hidden sm:block px-[20px]">
          ...
          <div className="nav-links flex w-[330px] h-[28px] gap-[40px] items-center text-footerText font-medium font-inter sm:hidden transition-all">
            <div
        ...
        <div className="nav-right w-[297px] h-[56px] flex gap-[10px] font-inter sm:hidden">
          <div className="login-button">
            <div className="button w-[118px] h-[56px] flex items-center justify-center rounded-[11px] border-[2px] border-green cursor-pointer text-[20px] font-medium text-green">
              Login
            </div>
          </div>
          <div className="signup">
            <div className="button w-[163px] h-[56px] flex items-center justify-center rounded-[11px] bg-green font-medium cursor-pointer text-heroText2 text-[20px]">
              Sign-up
            </div>
          </div>
        </div>
